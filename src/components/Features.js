        ...
        <div className='container'>
            <div className='features-container'>
                ...
                <div className='features-content'>
                    ...
                    <FeaturesPoints icon={codeIcon} heading='Add custom CSS' paragraph='Customize your personal portfolio even more with the ability to add you own custom CSS styles.' />
                    <FeaturesPoints icon={responsiveIcon} heading='Responsive' paragraph='All fiber templates are fully responsive to ensure the experience is seemless across all devices.' />
                </div>
            </div>
        </div>
    )
