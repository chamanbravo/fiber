...
function Hero({background, reviewText, titleText, descText, btnClasss1, btnClass2, btnText1, btnText2, check, heroimg, review, checklistText1, checklistText2, mainBg, padding, transform, textColor, textWidth}) {

    return (
        <>
          <div className='hero-container' style={{background: `var(${mainBg})`}}>
